...
// POST /vote/lock endpoint to create a new vote
router.post('/lock/:token', signVerify.verify, (req, res) => {
...
// GET /vote/lock/:token endpoint to get the poll details and the vote
...
// PUT /vote/lock/:token endpoint to update the vote
